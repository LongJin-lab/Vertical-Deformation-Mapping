...
parser.add_argument('--dir', type=str, default='/media/bdc/clm/DeformingTheLossSurface/Sparse-Sharpness-Aware-Minimization-main/contrib_swa_examples/logs/', required=True, help='training directory (default: None)')

parser.add_argument('--dataset', type=str, default='CIFAR10', help='dataset name (default: CIFAR10)')
parser.add_argument('--data_path', type=str, default='/media2/datasets/data/', required=True, metavar='PATH',
